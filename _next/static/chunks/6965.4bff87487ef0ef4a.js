...
`},56965:(e,t,r)=>{r.r(t),r.d(t,{default:()=>w});var n=r(37876),o=r(77232),a=r(40661);let i=o.default.div`
...
`;var l=r(79052),c=r(14232);let{height:b=0,width:s=0}=r(91372).A.BoxedWine.defaultSize||{},u={"inline-default-ondemand-root-overlay":"/wine1.7.55-v8-min-online",ondemand:"root",resolution:`${s}x${b}`,root:"/fullWine1.7.55-v8"};var d=r(68667),A=r(2435),g=r(46711),m=r(42771),p=r(60109),h=r(82909).Buffer;let k=({containerRef:e,id:t,setLoading:n,url:o})=>{let{appendFileToTitle:a}=(0,A.A)(t),{processes:{[t]:{libs:i=[]}={}}={}}=(0,m.N)(),{readFile:b}=(0,g.f)(),s=(0,d.A)(),k=(0,c.useRef)(),f=(0,c.useRef)(),w=(0,c.useCallback)(async()=>{let t,c={},d=o?await b(o):h.from(""),A=(0,p.uQ)(o),g=".exe"===A,{zipAsync:m}=await r.e(876).then(r.bind(r,30876)),k=(0,l.basename)(o,A),w=async()=>h.from(await m({[(0,l.basename)(o)]:d}));if(g)d=await w();else if(o){let{unzip:e}=await r.e(876).then(r.bind(r,30876));try{k=(e=>{let[[t]=[]]=Object.entries(e).filter(([e])=>e.toLowerCase().endsWith(".exe")).sort(([,e],[,t])=>t.length-e.length);return t})(await e(d))||""}catch{d=await w(),k=""}}c={...d?{"app-payload":d.toString("base64")}:{},...k?{p:k}:{}},f.current||(e.current?.prepend(document.createElement("ol")),f.current=window.setInterval(()=>{(0,p.b0)(e.current?.querySelector("canvas"))&&(clearInterval(f.current),f.current=void 0,e.current?.querySelector("ol")?.remove())},100)),window.BoxedWineConfig={...window.BoxedWineConfig,consoleLog:t=>{let r=e.current?.querySelector("ol");if(r){let e=document.createElement("li");e.textContent=t,r.append(e),r.scrollTop=r.scrollHeight,setTimeout(()=>r.scrollTo(0,r.scrollHeight),10)}},urlParams:(t=c,[...Object.entries(u),...Object.entries(t)].map(([e,t])=>`${e}=${t}`).join("&"))},(0,p.aY)(i).then(()=>{o&&a(k||(0,l.basename)(o));try{window.BoxedWineShell(()=>{n(!1),s(window.FS,"BoxedWine")})}catch{}})},[a,e,i,s,b,n,o]);(0,c.useEffect)(()=>(k.current!==o&&(o||!k.current)&&(k.current=o,w()),()=>{window.BoxedWineConfig={...window.BoxedWineConfig,isRunning:!1}}),[w,o])};var f=r(35144);let w=({id:e})=>(0,n.jsx)(f.A,{StyledComponent:i,id:e,useHook:k,children:(0,n.jsx)("canvas",{id:"boxedWineCanvas",onContextMenu:p.CH})})},68667:(e,t,r)=>{r.d(t,{A:()=>a});var n=r(14232),o=r(46711);let a=()=>{let{mountEmscriptenFs:e,unMapFs:t,updateFolder:r}=(0,o.f)(),a=(0,n.useRef)();return(0,n.useEffect)(()=>()=>{if(a.current){let e=a.current;a.current="",t(e,!0).then(()=>r("/",void 0,e)).catch(()=>{})}},[t,r]),(0,n.useCallback)(async(t,n)=>{if(!t)return;let o="";try{o=await e(t,n)}catch{}o&&(r("/",o),a.current=o)},[e,r])}},78011:(e,t,r)=>{r.d(t,{A:()=>g});var n=r(79052),o=r(14232),a=r(49697),i=r(84966),l=r(54188),c=r(46711),b=r(42771),s=r(70185),u=r(16361),d=r(60109),A=r(17786);let g=({callback:e,directory:t=u.Bn,id:r,onDragLeave:g,onDragOver:m,updatePositions:p})=>{let{url:h}=(0,b.N)(),k=(0,A.w)(),{iconPositions:f,sortOrders:w,setIconPositions:v}=(0,s.w)(),{exists:x,mkdirRecursive:$,updateFolder:y,writeFile:B}=(0,c.f)(),C=(0,o.useCallback)(async(e,t,o)=>{if(r)if(t){let a=(0,n.join)(u.Bn,e);if(await $(u.Bn),await B(a,t,!0))return o===l.z.UPDATE_URL&&h(r,a),y(u.Bn,e),(0,n.basename)(a)}else o===l.z.UPDATE_URL&&h(r,e);return""},[r,$,y,h,B]),{openTransferDialog:E}=(0,a.A)();return{onDragLeave:g,onDragOver:e=>{m?.(e),(0,d.CH)(e)},onDrop:o=>{if(u.jj.has((0,d.uQ)(t)))return;if(p&&o.target instanceof HTMLElement){let{files:e,text:r}=(0,i.bn)(o);if(0===e.length&&""===r)return;(async()=>{let a={x:o.clientX,y:o.clientY},i=[];if(r){try{i=JSON.parse(r)}catch{}if(!Array.isArray(i))return;let[e]=i;if(!e||e.startsWith(t)&&(0,n.basename)(e)===(0,n.relative)(t,e))return;i=i.map(e=>(0,n.basename)(e))}else i=e instanceof FileList?[...e].map(e=>e.name):[...e].map(e=>e.getAsFile()?.name||"").filter(Boolean);i=await Promise.all(i.map(async e=>{let r=`${t}/${e}`;if(!f[r]||!await x(r))return e;let o=0;do o+=1,r=`${t}/${(0,n.basename)(e,(0,n.extname)(e))} (${o})${(0,n.extname)(e)}`;while(f[r]&&await x(r));return(0,n.basename)(r)})),(0,d.$Y)(t,o.target,f,w,a,i,v,x)})()}let a="string"==typeof r;a&&!p&&t===u.Bn&&k.current[r]?.componentWindow?.focus(u.VD),(0,i.nX)(o,e||C,t,E,a)}}}}}]);