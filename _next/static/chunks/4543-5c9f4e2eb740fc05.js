...
`},41422:(e,t,n)=>{n.d(t,{A:()=>i});var r=n(42771),a=n(70185);let i=e=>{let{stackOrder:t=[]}=(0,a.w)(),{processes:n}=(0,r.N)();return t.find(t=>t!==e&&!n?.[t]?.minimized)||""}},44543:(e,t,n)=>{let r,a;n.d(t,{A:()=>eC});var i=n(37876),o=n(79052),l=n(14232),s=n(18847),c=n.n(s);let u=["name","date","type","size"],d={date:{name:"Date modified",width:133},name:{name:"Name",width:133},size:{name:"Size",width:70},type:{name:"Type",width:80}};var m=n(77232),p=n(20779);let f=m.default.div`
  display: flex;
  font-size: 12px;
