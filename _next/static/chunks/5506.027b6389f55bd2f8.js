"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[1894,5506,7970],{3350:(e,t,r)=>{r.d(t,{f:()=>w,A:()=>x});var o=r(37876),i=r(79052),a=r(14232),n=r(84788),s=r(77232);let l=s.default.div`
...
`;var c=r(64148),p=r(46711),d=r(42771),h=r(3861),u=r(16361),m=r(60109),f=r(54239),g=r(70185);let w={"aria-label":"Address",enterKeyHint:"go",inputMode:"url",name:"address",...u.m8},x=(0,a.forwardRef)(({id:e},t)=>{let r=(0,a.useRef)(null),{open:s,url:x,processes:{[e]:{icon:b,url:y=""}}}=(0,d.N)(),v=(0,a.useMemo)(()=>(0,i.basename)(y)||u.l6,[y]),[k,j]=(0,a.useState)(v),{exists:$,stat:C,updateFolder:D}=(0,p.f)(),{updateRecentFiles:A}=(0,g.w)(),S=(0,a.useMemo)(()=>k!==v&&k!==y&&document.activeElement===t.current,[k,t,v,y]),E=(0,a.useCallback)(async()=>{if(k&&await $(k))if((await C(k)).isDirectory())x(e,k);else{let e=(0,f.YD)((0,m.uQ)(k));s(e||"OpenWith",{url:k}),e&&A(k,e)}t.current?.blur()},[k,t,x,$,e,s,C,A]);return(0,a.useEffect)(()=>{t.current&&(k===y?t.current.select():k===v?window.getSelection()?.removeAllRanges():document.activeElement!==t.current&&j(v))},[k,t,v,y]),(0,o.jsxs)(l,{children:[(0,o.jsx)("input",{ref:t,className:S?"inputing":"",onBlurCapture:({relatedTarget:e})=>{r.current!==e&&j(y)},onChange:({target:e})=>j(e.value),onFocusCapture:()=>j(y),onKeyDown:({key:e})=>{"Enter"===e&&E()},value:y,...w,...(e=>{let{contextMenu:t}=(0,c.b)();return(0,a.useMemo)(()=>t?.(()=>[{action:()=>navigator.clipboard?.writeText(e),label:"Copy address"}]),[e,t])})(y)}),(0,o.jsx)(h.A,{ref:r,className:"action",onClick:()=>{j(y),S?E():D(y)},onFocusCapture:()=>setTimeout(()=>j(y),u.UW.DOUBLE_CLICK/2),...(0,m.Pf)(S?`Go to "${k}"`:`Refresh "${v}" (F5)`),children:S?(0,o.jsx)(n.GoTo,{}):(0,o.jsx)(n.Refresh,{})})]})})},11894:(e,t,r)=>{r.d(t,{getIpfsFileName:()=>c,getIpfsGatewayUrl:()=>l,getIpfsResource:()=>p});var o=r(16361),i=r(82909).Buffer;let a="",n=["https://<CID>.ipfs.cf-ipfs.com/","https://<CID>.ipfs.dweb.link/","https://cloudflare-ipfs.com/ipfs/<CID>/","https://gateway.ipfs.io/ipfs/<CID>/"],s=e=>new Promise(t=>{let r=window.setTimeout(()=>t(!1),o.iC),i=new Image;i.addEventListener("load",()=>{window.clearTimeout(r),t(!0)},o.w3),i.addEventListener("error",()=>{window.clearTimeout(r),t(!1)},o.w3),i.src=`${e.replace("<CID>","bafybeibwzifw52ttrkqlikfzext5akxu7lz4xiwjgwzmqcpdzmp3n5vnbe")}?now=${Date.now()}&filename=1x1.png#x-ipfs-companion-no-redirect`}),l=async(e,t)=>{if(!a||t){for(let e of t?n.filter(e=>e!==a):n)if(await s(e)){a=e;break}if(!a)return""}let{pathname:o,protocol:i,search:l}=new URL(e);if("ipfs:"!==i)return"";let[c="",...p]=o.split("/").filter(Boolean),{CID:d}=await r.e(3148).then(r.bind(r,43148));return`${a.replace("<CID>",d.parse(c).toV1().toString())}${p.join("/")}${l}`},c=async(e,t)=>{let{pathname:o,searchParams:i}=new URL(e),a=i.get("filename");if(a)return a;let{fileTypeFromBuffer:n}=await r.e(8338).then(r.bind(r,98338)),{ext:s=""}=await n(t)||{};return`${o.split("/").filter(Boolean).join("_")}${s?`.${s}`:""}`},p=async e=>{let t,r={...o.c9,cache:"no-cache",credentials:"omit",keepalive:!1,mode:"cors",referrerPolicy:"no-referrer",window:null};try{t=await fetch(await l(e),r)}catch(o){"Failed to fetch"===o.message&&(t=await fetch(await l(e,!0),r))}return t instanceof Response?i.from(await t.arrayBuffer()):i.from("")}},15674:(e,t,r)=>{r.d(t,{A:()=>i});var o=r(77232);let i=o.default.button`
