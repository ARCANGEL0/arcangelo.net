...
`},96292:(e,t,r)=>{r.r(t),r.d(t,{default:()=>x});var i=r(37876),a=r(77232),o=r(14232),n=r(44543),s=r(20779),l=r(86076),u=r(8431),c=r(41824),d=r(40661),p=r(16361);let h=(0,a.default)(s.m.nav)`
...
`;var b=r(96438);let g=a.default.span`
  ...
  width: 100%;
  z-index: -1;
`;var $=r(4213),v=r(22391),w=r(52179);let x=({toggleStartMenu:e})=>{let t=(0,o.useRef)(null),{sizes:{startMenu:r}}=(0,a.useTheme)(),[s,l]=(0,o.useState)(!1),u=(0,o.useMemo)(()=>CSS.supports("selector(::-webkit-scrollbar)"),[]),c=(0,o.useMemo)(()=>r.size-(u?p.a_:p.Jf),[u,r.size]),d=(0,o.useCallback)(({clientX:e=0})=>l(e>c),[c]),x=(0,o.useCallback)(e=>{e?.focus(p.VD),t.current=e},[]),f=(0,v.A)(r.maxHeight),{height:k}=f.variants?.active??{};return(0,i.jsxs)(h,{ref:x,$showScrolling:s,id:"startMenu",onBlurCapture:r=>(0,$.Q2)(r,t.current,e,void 0,$.r5),onKeyDown:({key:t})=>{if("Escape"===t)e(!1);else if(1===t.length){e(!1);let r=(0,w.t)($.BN);if(r){r.click();let e=0,i=window.setInterval(()=>{let r=document.querySelector("main > nav .search > input");r&&(0,b.V0)(r,t),(r||++e>10)&&window.clearInterval(i)},50)}}},onMouseLeave:()=>l(!1),onMouseMove:d,...f,...p.W8,children:[(0,i.jsx)(g,{$height:k}),(0,i.jsx)(n.A,{url:p.Z$,hideLoading:!0,hideShortcutIcons:!0,isStartMenu:!0,loadIconsImmediately:!0,readOnly:!0,skipFsWatcher:!0,skipSorting:!0})]})}},96438:(e,t,r)=>{r.d(t,{$A:()=>u,V0:()=>l,cK:()=>s});var i=r(79052),a=r(54239),o=r(16361),n=r(60109);let s=async(e,t,r)=>{if(!e)return;let{subIcons:s,icon:l,pid:u=o.hr[0],url:c}=await new Promise(r=>{e.lstat(t,(i,o)=>{let s=!i&&!!o&&o.isDirectory(),l=(0,n.uQ)(t);l&&!s?(0,a.O6)(e,t,l,e=>r(e)):(0,a.qz)(e,e.getRootFS(),t,s,!1,e=>r(e),!1)})});if(r?.aborted)return;let d=(0,n.t$)(c);return{icon:await (0,a.$j)(e,(0,i.join)(d?o.zP:o.jv,`${d?new URL(c).pathname.replace("/",""):c}${o.V9}`))||l,pid:u,subIcons:s?.includes(o.N9)?s:[],url:c||t}},l=(e,t)=>{let r=0===e.value.length,i=()=>{Object.getOwnPropertyDescriptor(Object.getPrototypeOf(e),"value")?.set?.call(e,t),e.dispatchEvent(new Event("input",{bubbles:!0}))};i(),requestAnimationFrame(()=>r&&1===t.length&&2===e.value.length&&i())},u=(e,t,r,i,o)=>o?"Nostr URI":i?"App":r?"YouTube Video":e?.isDirectory()||!t?"File folder":(0,a.ti)(t)}}]);