"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[7777],{2435:(e,t,r)=>{r.d(t,{A:()=>l});var i=r(14232),n=r(42771),s=r(91372),a=r(16361);let l=e=>{let{title:t}=(0,n.N)(),[r]=e.split(a.QB),{title:l}=s.A[r]||{};return{appendFileToTitle:(0,i.useCallback)((r,i)=>{let n=r?` - ${r}${i?` ${a.g6}`:""}`:"";t(e,`${l}${n}`)},[e,l,t]),prependFileToTitle:(0,i.useCallback)((r,i,n)=>{let s=r?`${i?`${a.g6} `:""}${r}${n?" ":" - "}`:"";t(e,`${s}${l}`)},[e,l,t])}}},15674:(e,t,r)=>{r.d(t,{A:()=>n});var i=r(77232);let n=i.default.button`
